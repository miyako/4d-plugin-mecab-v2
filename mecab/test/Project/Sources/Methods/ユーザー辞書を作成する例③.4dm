...
//単語データは2行目以降に
$data.push(New collection:C1472("ルペック"; 1293; 1293; 10000; "名詞"; "固有名詞"; "地域"; "一般"; "*"; "*"; "ルペック"; "ルペック"; "ルペック"))
$data.push(New collection:C1472("リバルディエール"; 1291; 1291; 10000; "名詞"; "固有名詞"; "人名"; "名"; "*"; "*"; "リバルディエール"; "リバルディエール"; "リバルディエール"))
...
//追加の設定ファイル
$options.model:=Get 4D folder:C485(Current resources folder:K5:16)+"ipadic.utf8.model.bin"
$options.feature:=Get 4D folder:C485(Current resources folder:K5:16)+"ipadic.utf8.feature.def"
