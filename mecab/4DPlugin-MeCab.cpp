...
void PluginMain(PA_long32 selector, PA_PluginParameters params) {
	...
	try
	{
        switch(selector)
        {
			...
			case 1 :
				MeCab_SET_MODEL(params);
				break;
			case 2 :
				MeCab_Get_model(params);
				break;
			case 3 :
				_MeCab(params);
				break;
			case 4 :
				MeCab_INDEX_DICTIONARY(params);
				break;
			case 5 :
				MeCab_GENERATE_DICTIONARY(params);
				break;
...
static void convertFromString(std::string &fromString, C_TEXT &toString)
{
#ifdef _WIN32
...
static void convertToString(C_TEXT &fromString, std::string &toString)
{
#ifdef _WIN32
...
void MeCab_SET_MODEL(PA_PluginParameters params) {
...
void MeCab_Get_model(PA_PluginParameters params) {
...
void _MeCab(PA_PluginParameters params) {
...
void MeCab_INDEX_DICTIONARY(PA_PluginParameters params) {
...
void MeCab_GENERATE_DICTIONARY(PA_PluginParameters params) {
