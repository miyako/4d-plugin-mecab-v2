...
class DoubleArrayImpl {
 private:
  ...
  bool          no_delete_;
  int           error_;
  void          *callback_method_;
  int (*progress_func_)(size_t, size_t, void*);
   ...
   next:
    ...
    for (size_t i = 0; i < siblings.size(); ++i) {
      ...
      if (!fetch(siblings[i], new_siblings)) {
        ...
        ++progress_;
        if (progress_func_)(*progress_func_)(progress_, key_size_, callback_method_);
 ...
 public:
  ...
  int build(size_t     key_size,
            ...
            size_t     *length = 0,
            value_type *value = 0,
            int (*progress_func)(size_t, size_t, void*) = 0,
